...
class OpcaoVariacao extends Component {
  ...
  validate(){
    ...
    if(!freteGratis) erros.freteGratis = "Selecione uma opção"
        ...
        <TextoDados
          ...
          valor={(
            <InputValor
              ...
              name="largura" erro={erros.largura}
              type="number"
        ...
        <TextoDados
          ...
          valor={(
            <InputValor
              ...
              name="comprimento" erro={erros.comprimento}
              type="number"
