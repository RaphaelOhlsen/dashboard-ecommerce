...
class DetalhesDoCliente extends Component {
 ...
 componentWillUpdate(nextProps){
  ...
  generateStateCliente = (props) => ({
    ...
    dataDeNascimento: props.cliente ? moment(props.cliente.dataDeNascimento).add(1,"days").format("DD/MM/YYYY") : "",
  ...
  removerCliente(){
    ...
    if(window.confirm("Voce realmente deseja remover este cliente?00")){
        ...
        </div>
        {
          cliente && cliente.deletado ? (
            <div className="flex-1 flex flex-end">
              <Button label="Removido" type="danger" />
            </div>
          ) : (
            <div className="flex-1 flex flex-end">
              <Button 
